...
//  CookieCrunch
//
//  Created by Desireé Bryant on 5/27/17.
...
class Level {
  ...
  fileprivate func calculatesScores(for chains: Set<Chain>) {
    for chain in chains {
  ...
  func removeMatches() -> Set<Chain> {
    ...
    calculatesScores(for: horizontalChains)
    calculatesScores(for: verticalChains)
    
    return horizontalChains.union(verticalChains)
  }
  
  fileprivate func removeCookies(chains: Set<Chain>) {
    for chain in chains {
